  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 flex max-h-[85svh] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 flex-col gap-4 overflow-y-auto rounded-xl border border-[oklch(0.88_0.04_82/0.8)] bg-popover bg-clip-padding p-5 text-sm text-popover-foreground shadow-xl shadow-[oklch(0.3_0.03_55/0.12)]",
